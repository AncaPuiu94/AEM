...
<cq:includeClientLib categories="AEM62App.components" />
...
<div class="imagineamea">
    <img src="<%=currentNode.getNode("image1").getProperty("fileReference").getString()%>"/>
</div>
